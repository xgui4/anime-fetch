...
[Files]
Source: "..\..\out\build\release\gui\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\out\build\release\gui\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
